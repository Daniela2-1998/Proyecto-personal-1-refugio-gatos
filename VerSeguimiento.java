 ...
 * @author Daniela
 */
public class VerSeguimiento extends javax.swing.JFrame {
    ...
    public VerSeguimiento() {
        ...
        setTitle("Seguimiento de adaptación - " + usuario);
  ...
  // colocar logo
    ...
    public void cargarDatos(){
        ...
        try{
            ...
            PreparedStatement pst = cn.prepareStatement("select Familia, NombreNuevo, "
                    + "EstadoVet, Comportamiento from seguimiento");
            ResultSet rs = pst.executeQuery();
            
            jTableSeguimiento = new JTable(modelo);
            jScrollPane1.setViewportView(jTableSeguimiento);
            
            modelo.addColumn("Familia");
            modelo.addColumn("NombreNuevo");
            modelo.addColumn("EstadoVet");
    ...
    private void initComponents() {
        ...
        jLabelNombre.setText("Buscar por familia o nombre gato:");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(textBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 207, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        try{
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement("select Familia, NombreNuevo, "
                    + "EstadoVet, Comportamiento from seguimiento where "
                    + "Familia = '" + buscar + "' or NombreNuevo = '" + buscar + "'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VerSeguimiento.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VerSeguimiento().setVisible(true);
            }
        });
    }
